...
var esprimatch = function() {
  ...
  function literal(value) {
    return function(node, parent) {
      ...
      if (typeMatches && typeof value !== 'undefined') {
        return value(value)(node, parent);
      }
      return typeMatches;
    }
  }
  ...
  function or(predicate1, predicate2) {
    var predicate1Wrapper = predicateWrapper(predicate1);
    var predicate2Wrapper = predicateWrapper(predicate2);
    return function(node, parent) {
      return predicate1Wrapper(node, parent) || predicate2Wrapper(node, parent);
    }
  }
  ...
  return {
    ...
    args: function() {
      var args = arguments;
      return function(node, parent) {
        return allOf.apply(null, args)(node.arguments);
      };
    },
      ...
      return function(node) {
        ...
        if (typeMatches) {
          ...
          if (methodMatches && methodArgs) {
            return args.apply(null, methodArgs)(node);
          }
